<template>
  <div>
    <page-title class="py-2"
      ><span><fa class="users px-2" icon="users" /></span>
      {{ $t("branchesAndUsers") }}</page-title
    >
    <div class="row a py-2">
      <div class="col-4" style="padding-left: 0">
        <element-button class="building px-2" @click="newBranch"
          ><span><fa class="fa" icon="building" /></span
        ></element-button>
        <element-button class="building px-2"
          ><span><fa class="fa" icon="user-plus" /></span
        ></element-button>
        <element-button class="building px-2"
          ><span><fa class="fa" icon="magnifying-glass" /></span
        ></element-button>
      </div>
